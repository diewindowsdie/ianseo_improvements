...
echo '<tr class="HideSelection">'.
    ...
    '<td colspan="10" class="Bold">'.get_text('SelectedMove2Group', 'Api').'<select class="mx-3" id="MoveToGroup">'.$tmpOptionsGrp.'</select><input class="iskButton" type="button" value="'.get_text('CmdExec', 'Tournament').'" onclick="MoveToGroup()"></td>'.
    '</tr>';
echo '<tr class="HideSelection">'.
    '<td colspan="10" class="Bold">'.get_text('SelectedReNumber', 'Api').'<input class="mx-3" id="RenumberFrom" size="3"><input class="iskButton" type="button" value="'.get_text('CmdExec', 'Tournament').'" onclick="AssignFrom()"></td>'.
    '</tr>';
