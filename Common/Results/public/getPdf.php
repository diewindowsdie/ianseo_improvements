...
$_REQUEST["TourId"] = $competition->ToId;

switch ($_REQUEST["report"]) {
    case 'qI':
        $_REQUEST["Event"] = getVisibleEventCodesConsideringTeams($competition->ToId, "0");

        require_once "../../../Qualification/PrintIndividual.php";
        break;
    case 'qT':
        $_REQUEST["Event"] = getVisibleEventCodesConsideringTeams($competition->ToId, "1");
    ...
    case 'rT':
        ...
        break;
    case "qcI":
        if (getModuleParameter(RESULTS_PUBLICATION_MODULE_NAME, PUBLISH_SCORECARDS_PARAM_NAME, "1", $competition->ToId) === "0") {
            exitNotFound();
        }
        ...
        $maxDistancesQuery = "select max((QuD1Arrowstring != '') + (QuD2Arrowstring != '') + (QuD3Arrowstring != '') + (QuD4Arrowstring != '') +
                                ...
                                where e.EnTournament = " . StrSafe_DB($competition->ToId) . " and q.QuSession = " . $_REQUEST["session"];
    ...
    case "sac":
        ...
        $_REQUEST["TeamEvents"] = getVisibleEventCodesConsideringTeams($competition->ToId, "0");
    ...
    case "fs":
        ...
        $_REQUEST["ses"] = getModuleParameter(RESULTS_PUBLICATION_MODULE_NAME, SHOW_FINAL_SESSIONS_IN_SCHEDULE_PARAM_NAME, array(), $competition->ToId);
    ...
    case "p":
        ...
        $_REQUEST["Events"] = getVisibleEventCodesConsideringTeams($competition->ToId, "0");
        $_REQUEST["TeamEvents"] = getVisibleEventCodesConsideringTeams($competition->ToId, "1");
