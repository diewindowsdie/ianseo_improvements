...
echo '
    <form>
        <table class="Tabella w-40" style="margin: 20px">
            ...
            <tr><td><input type="checkbox" id="' . HIDE_DRAW . '"' . (getModuleParameter(RESULTS_PUBLICATION_MODULE_NAME, HIDE_DRAW, "0", $_SESSION['TourId']) === "1" ? ' checked="checked"' : '') . ' onchange="toggleResultsCheckbox(this, false)"></td><td>Скрывать результаты жеребьевки</td></tr>
