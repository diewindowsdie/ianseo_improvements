...
echo '<tr><td><input type="checkbox" id="' . Checked1ParameterName . '"' . (getModuleParameter(PROTOCOL_MODULE, Checked1ParameterName, "1", $_SESSION['TourId']) === "1" ? ' checked="checked"' : '') . '" onchange="toggleProtocolRelatedCheckbox(this)"/></td>
...
echo '<tr><td><input type="checkbox" id="' . Checked2ParameterName . '"' . (getModuleParameter(PROTOCOL_MODULE, Checked2ParameterName, "1", $_SESSION['TourId']) === "1" ? ' checked="checked"' : '') . '" onchange="toggleProtocolRelatedCheckbox(this)"/></td>
...
echo '<tr><td><input type="checkbox" id="' . Checked3ParameterName . '"' . (getModuleParameter(PROTOCOL_MODULE, Checked3ParameterName, "1", $_SESSION['TourId']) === "1" ? ' checked="checked"' : '') . '" onchange="toggleProtocolRelatedCheckbox(this)"/></td>
