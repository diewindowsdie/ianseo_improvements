...
echo '<tr><th style="width:30%">'.get_text('CalcSnapshot', 'Tournament').'</th><td colspan="2"><input type="checkbox" id="snapshot" '. (getModuleParameter('ISK-NG', 'Snapshot') ? 'checked="checked"' : '') .' onclick="toggleSnapshot(this)"></td></tr>';

echo '<tbody id="Conf" '.(getModuleParameter('ISK-NG', 'Snapshot') ? '' : 'style="display:none"').'>';
