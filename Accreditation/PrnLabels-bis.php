...
if($_POST) {
	...
	if($IncludePicture) {
		...
		$MySQL="select"
			...
			. (isset($_REQUEST["Session"]) && is_numeric($_REQUEST["Session"]) ? " AND QuSession = " . StrSafe_DB($_REQUEST["Session"]) . " " : '')
