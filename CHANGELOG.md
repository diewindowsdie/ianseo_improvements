# Список изменений относительно коробочной, "ванильной" версии IANSEO 2025-09-03 (rev 254):
## Список изменений v5.6:
* Добавлено скрытие полного ФИО спортсменов и дат их рождения в отчетах аккредитации в случае, если соответствующая галочка включена для данного соревнования;
* Стандартные названия спортивной дисциплины, добавляемые при создании соревнования, перенесены в раздел Распечатки - Заголовки для печати результатов;
* Добавлена возможность скрывать данные спортсмена из полей Регион/Команда 1, 2 и 3, и настраивать необходимость их скрытия в распечатках (отчетах), трансляции результатов и интерфейсе IANSEO;
* Незначительное улучшение отображения количества подключенных сессий управления смартфонами для Pro и Live соревнований;
* Исправлено отображение выполненных нормативов в отчете "Результаты по категориям";
* Исправление склонения названия региона в родительный падеж в некоторых сложных случаях;
## Список изменений v5.5:
* Обновлена базовая версия Ianseo до 2025-09-03 (rev 254);
* Добавлено более явное выделение победителя в сетках - полужирным и светло-серым фоном;
* Добавлено отображение названия этапа финальных матчей над соответствующими столбцами сеток;
* Исправлено отображение лесенок для соревнований в дисциплине 3Д в формате World Archery - 4 группы;
* Исправлены настройки доступа ввода результатов из приложения - убрано дублирование настроек, убраны настройки для отборочных этапов, выделены отдельные настройки для 3D по стандартным правилам WA с 4 группами;
* В карточках записи результатов отборочного этапа и результатов филд-соревнований скрыт код региона спортсмена;
* Исправлено формирование карточек записи результатов отборочного этапа для случаев, когда первая мишень начинается с чётной буквы (B, D, F и т.д.);
* Исправления реализации скрытия полного ФИО спортсменов и даты рождения в случае, если стоит соответствующая галочка в настройках соревнования;
* Исправлено отображение контента трансляции - список участников по мишеням;
* Добавлена возможность настроить механизм обновления на использование LTS-ветки и отказаться от регулярных обновлений;
## Список изменений v5.4:
* Обновлена базовая версия Ianseo до 2025-09-03 (rev 231);
* При формировании отчета ГСК в различной статистике по спортсменам учитываются только те участники соревнований, у дивизиона и класса которых стоит признак "Спортсмен";
* При формировании отчета ГСК в случае, если не указано, судьи из какого региона не считаются иногородними - иногородними не считается никто;
* При формировании отчета ГСК значением по умолчанию для поля "Количество тренеров и другого обслуживающего персонала" для каждого региона считаем количество участников соревнования, для дивизиона или класс которых флаг "Спортсмен" установлен в "Нет";
* Исправлена опечатка в значении по умолчанию поля "Медицинское обеспечение соревнований";
* В форме редактирования деталей участника соревнования разрешены сочетания дивизиона и класса, флаг "Спортсмен" которых имеет отличающиеся друг от друга значения;
* На странице ручного редактирования назначенных мишеней кнопки "Поменять местами соперников" отображаются только в случае, если у всех спортсменов в выбранной смене (сменах) уже назначена мишень;
* Различные улучшения локализации Ianseo Scorekeeper NG на русский язык, в основном связанные с круговыми спаррингами;
* При вводе данных индивидуальных и командных финалов добавлена возможность перевода в следующий этап всех лидеров матчей, а не только тех, кто победил в своем матче;
* Исправлено отображение щитов разминки перед квалификацией в разметке поля;
* Добавлены нормативы для упражнения СД-1 (три летние дистанции) беларусской федерации стрельбы из лука;
* На странице распечаток списков участников добавлена возможность фильтровать список по коду события индивидуальных финалов (коду группы);
* В опции макета личных дипломов добавлена поддержка вывода дивизиона, класса и названия класса в родительном падеже (для стандартных названий классов);
* Для спортсменов со статусом IRM в квалификации, предполагающим сохранение результата, примечание, если оно есть, сделано более читаемым в протоколе;
## Список изменений v5.3:
* Обновлена базовая версия Ianseo до 2025-09-03 (rev 183);
* Исправлена верстка карточек записи результатов круговых спаррингов для предотвращения налезания названия этапа на надпись "Победитель";
* Исправлен формат даты будущих матчей в сетках для круговых спаррингов;
* Из результатов круговых спаррингов убран код команды;
* Не показываем 0 в качестве мишени в деталях спортсмена, если мишень еще не назначена;
* Добавлена возможность использовать разные настройки нормативов для разных типов соревнований;
* Добавлены российские нормативы для стрельбы из лука лиц с ПОДА;
* Добавлен набор стандартных правил Беларусской федерации стрельбы из лука;
* Добавлены нормативы Беларусской федерации стрельбы из лука;
* Скрыт стандартный механизм обновления ianseo и заменен на обновление improvements;
## Список изменений v5.2:
* Обновлена базовая версия Ianseo до 2025-09-03 (rev 130);
* В форме подтверждения результатов финальных матчей (таблица) переводятся в следующий этап только победители уже завершившихся матчей;
* Механизм обновления теперь позволяет устанавливать не только последний, но и любой другой релиз новее установленного;
* Улучшена локализация расписания для круговых спаррингов;
* Улучшена локализация информации о требуемом попадании, используемая в видеотрансляции;
* Улучшена трансляция матчей круговых спаррингов;
* ## Список изменений v5.1:
* В ручном управлении распределением щитов добавлена возможность менять местами спортсменов на различных индексах;
* В основные настройки соревнования добавлена галочка, скрывающая отчество и полную дату рождения спортсменов в отчетах;
* Исправлен баг появления повторяющихся значений в комбобоксе со списком классов спортсмена в форме редактирования деталей спортсмена;
* Предотвращен отрыв подписей ГСК от списка медалистов;
* Добавлена возможность выбирать, какие события включить в итоговый протокол соревнований;
* Исправление работы механизма обновления под Windows;
* Добавлена поддержка названия региона в родительном падеже в макетах дипломов и имена участников команды в шаблонах дипломов команд;
## Список изменений v5.0:
* Изменена система именования версий проекта, отныне все версии имеют вид vX.Y[.Z];
* Обновление ianseo_improvements больше не требует обновления ianseo с помощью встроенного инструмента обновления;
* Результаты перестрелок теперь обозначаются буквой П. в сетках, лесенках и результатах квалификации;
* Исправлено отображение участия в командных событиях в отчете "Список спортсменов по регионам";
* В таблицу аккредитации участников добавлена дата рождения спортсмена;
* При рендере разметки поля для команд всегда считаем, что мишеней на щите две, исключая случай 122см мишени;
* Исправлен экспорт и импорт отчета ГСК - данные, привязанные к регионам (базовый ли вид спорта, количество тренеров, с какого региона не-иногородние судьи) теперь привязаны к кодам регионов, не к их идентификаторам;
* Отметка "Ближайшая к центру" в заполненных карточках личных финалов теперь рисуется корректно;
* QR-код и штрих-код в карточках записи круговых спаррингов рисуются на свободном месте, не поверх заголовка;
* В полных результатах квалификации результаты команд всегда начинаются с новой страницы;
* Добавлена возможность скрывать заголовки групп личной и командной квалификации при печати отчета "Результаты квалификационных раундов";
* Обновление деталей спортсмена и установка спортсмену существующего региона/команды без детального названия не заменяет пустое детальное название коротким;
* Исправлено пропадание номеров щитов и времени матча в личных и командных сетках для второго и последующих этапов;
* Надписи "Бронза" и "Золото" в командных сетках немного отодвинуты от времени и щита матча;
* В форме ввода результатов по одной пробоине матчи, в которых победитель уже переведён в следующий этап, помечаются зеленым фоном;
* В инструмент обновления добавлен список файлов-исключений, которые обновлять не нужно;
## Список изменений ianseo_improvements_2025-09-03_rev47_v4.15.2:
* В отчет ГСК добавлено общее количество награжденных спортсменов и отметка "Место для печати";
## Список изменений ianseo_improvements_2025-09-03_rev47_v4.15.1:
* Реализован механизм автоматического обновления ianseo_improvements c github;
* При загрузке флагов регионов/команд теперь отображаются все регионы, а не только те, для которых существуют участники;
## Список изменений ianseo_improvements_2025-09-03_rev47_v4.15:
* Исправлено формирование отчета ГСК в случаях, когда в строках присутствуют кавычки;
* По умолчанию время прокрутки одной строки в трансляциях установлено в 2 секунды;
* При отображении требуемых подклассов (разрядов) для участия в личных и командных финалах теперь показывается описание разряда рядом с кодом;
* Добавлена возможность распечатать список спортсменов по регионам, разделяя регионы по страницам;
* Исправлено отображение флагов в трансляциях;
## Список изменений ianseo_improvements_2025-09-03_rev47_v4.14.1:
* Запрет использования символа _ в коде события личных или индивидуальных финалов;
* Исправления отображения PDF расписания - новые страницы и заголовки продолжения "дня" добавляются более корректно;
## Список изменений ianseo_improvements_2025-09-03_rev47_v4.14:
* Обновлена базовая версия Ianseo до 2025-09-03 (rev 47);
* Добавлено отображение зелёной галочкой спортсмена или команды, перенесённой в следующий этап соревнования, в форме ввода результатов по отдельной стреле;
* Добавлена поддержка поиска по кодам регионов, написанных кириллицей;
* Более корректное отображение судей без отчества в судейской справке;
* В настройках правил трансляции финалов опция Follow group доступна, если соревнование использует Scorekeeper Pro или Live, и есть устройства в группе;
* В распечатке разметки поля теперь указано количество мишеней на щит в разминке перед финалами, и не рисуются элементы разминки перед квалификацией по несуществующим щитам;
* Время матча и номер щита для матчей bye теперь отображаются, если еще не определен соперник в следующем поединке;
* Форма редактирования полей отчета ГСК сделана более удобной для экранов ноутбуков;
* Форма ввода результатов перестрелки и подтверждения необходимости второй перестрелки в приложении Scorekeeper NG локализована на русский язык;
* Установка статусов IRM, не предполагающих ранги (DNS, DNF, DSQ) во время финалов, и статуса bye, двигают в следующий этап только спортсмена из матча, в котором участвует спортсмен;
## Список изменений ianseo_improvements_2025-09-03_rev32_v4.13.1:
* В заголовках всех отчетов выводится и название площадки, где проходит соревнование, если название площадки заполнено;
* В командных сетках предотвращено налезание заголовка на саму сетку;
* При вводе и редактировании фамилии, имени и отчества спортсмена и названия региона регистр символов не преобразуется, а остается как есть;
## Список изменений ianseo_improvements_2025-09-03_rev32_v4.13:
* Добавлена возможность автоматической генерации отчета ГСК;
* При вводе результатов личных и командных финалов с помощью формы-сетки на местах где участников нет, поля ввода не отображаются;
* Отчества судей сделаны необязательными;
* Исправлен баг отображения неправильных разрядов в результатах жеребьевки;
* Таблицы со статистикой по имеющимся разрядам и выполненным нормативам повернуты на 90 градусов, и исправлен баг подсчета статистики;
* Исправлен заголовок полей таблицы с датой рождения;
* Добавлен перевод заголовка поля Venue в основных настройках соревнования и корректное отображение значений поля с кавычками;
* Убрана возможность загрузки языковых констант с серверов IANSEO;
## Список изменений ianseo_improvements_2025-09-03_rev32_v4.12:
* При изменении границ допустимых возрастов для классов больше не проверяем другие классы;
* Исправление локализации терминов, связанных с площадками, где идет стрельба, в управлении сменами;
* Локализована кнопка импорта данных с устройства на странице результатов при проведении live и pro соревнований;
* Автообновление канала вывода на ТВ теперь работает более корректно;
* В трансляции списка спортсменов по мишеням поддерживаются флаги и полное название региона;
* Улучшения перевода интерфейса Scorekeeper NG на русский язык;
* На странице основных настроек соревнования скрывается предложение создать идентификаторы разрядов для уже существующих соревнований;
* Более понятно сформулирован текст ошибки, возникающей при попытке перенести спортсмена в смену, где уже нет места на щитах;
* Используется региональный формат дат при выводе даты рождения спортсмена в карточках квалификации;
* В списке спортсменов в динамически формируемых полях ввода, например при правке имени спортсмена, нажатие Enter теперь сохраняет введенное в поля ввода;
* Изменение разряда спортсмена вызывает сброс сеток только в случае, если в формировании сеток на личные или командные финалы в данном соревновании используются разряды;
* При изменении названии региона из карточки спортсмена регион создается или обновляется, включая поле с его полным названием;
## Список изменений ianseo_improvements_2025-09-03_rev32_v4.11:
* Обновлена базовая версия Ianseo до 2025-09-03 (rev 32);
* Исправлен баг с невозможностью сохранить канал вывода с соревнованием с длинным ID;
* Улучшения отчетов аккредитации, связанных со сбором стартовых взносов;
* К отчетам аккредитации по имении и по региону добавлены заголовки с названием отчета;
* Исправлено отображение информации о текущем и других активных контроллерах для live соревнований;
* Сумма собранных взносов видна, даже если редактирование аккредитации заблокировано или база была импортирована с удаленного сервера;
## Список изменений ianseo_improvements_2025-09-03_rev26_v4.10:
* Исправления отображения и сохранения примечаний к устройствам для pro и live соревнований;
* Можно удалять назначенный смартфону щит в управлении устройствами для pro и live соревнований;
* В отчете аккредитации участников скрыта возрастная категория и номер спортсмена, добавлен полный регион и звание/разряд;
* В управлении аккредитацией спортсменов подсчет общей суммы собранных стартовых взносов больше не зависит от статуса аккредитации;
* В форме редактирования участия спортсмена в командных событиях добавлено отчество и полный регион, и поиск по ним; 
* Если список победителей и призеров занимает больше одной страницы, на второй и последующих появится надпись "Продолжение" в заголовке;
...
* Добавлена возможность группировать отчет аккредитации по второму и третьему полю региона спортсменов;
...
## Список изменений ianseo_improvements_2025-05-29_rev94_v4.6.7:
...
* Использован российский формат дат везде;
...
* В отчете "Расписание соревнований" исправлено дублирование заголовка "Квалификационный раунд" в случае, когда есть эвенты в день квалификации, предшествующие ей;
