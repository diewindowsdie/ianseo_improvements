# Список изменений относительно коробочной, "ванильной" версии IANSEO 2025-02-10 (rev32):
...
* Исправлено формирование отчета "Список спортсменов по мишениям" в случае, когда необходимо выводить тип мишеней спортсменов;
