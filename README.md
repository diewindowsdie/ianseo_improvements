...
* Скачать архив из раздела ***releases*** данного сайта. Рекомендуется использовать релиз с пометкой **Latest** и не использовать LTS-релизы с пометкой **Pre-release**;
