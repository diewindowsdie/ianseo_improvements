...
if($_POST['TourReset'] =='on'){
    ...
    if (!$run) {
        error_log("TourReset class update failed for TourId: $TourId");
...
function CreateStandardClasses($TourId, $subRuleName,$TourType) {
    $i=1;
if (str_contains($_POST['d_ToCode'],"BUCS")){
    CreateClass($TourId, $i++, 1, 100, -1, 'EO', 'EO', 'Experienced Open');
    CreateClass($TourId, $i++, 1, 100, 1, 'EF', 'EF', 'Experienced Female');
    CreateClass($TourId, $i++, 1, 100, -1, 'NO', 'NO', 'Novice Open');
    CreateClass($TourId, $i++, 1, 100, 1, 'NF', 'NF', 'Novice Female');
}
else{
        switch ($TourType) {
            case 40:
                CreateClass($TourId, $i++, 21, 49, -1, 'O', 'O', 'Open');
                CreateClass($TourId, $i++, 21, 49, 1, 'W', 'W', 'Female');
                CreateClass($TourId, $i++, 18, 20, -1, 'U21O', 'U21O,O', 'Open U21');
                CreateClass($TourId, $i++, 18, 20, 1, 'U21W', 'U21W,W', 'Female U21');
                CreateClass($TourId, $i++, 16, 17, -1, 'U18O', 'U18O,U21O,O', 'Open U18');
                CreateClass($TourId, $i++, 16, 17, 1, 'U18W', 'U21W,U18W,W', 'Female U18');
                CreateClass($TourId, $i++, 14, 15, -1, 'U16O', 'U21O,U18O,U16O,O', 'Open U16');
                CreateClass($TourId, $i++, 14, 15, 1, 'U16W', 'U21W,U18W,U16W,W', 'Female U16');
        ...
        if(str_contains($_POST['d_ToCode'],"BUCS")){
            ...
            switch ($TourType) {
                case 40:
                    ...
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RW', $W . 'Recurve Female', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CW', $W . 'Compound Female', $SetC, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LW', $W . 'Longbow Female', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BW', $W . 'Barebow Female', 1, 240);
                    ...
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU21W', $W . 'Recurve Female Under 21', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU21W', $W . 'Compound Female Under 21', $SetC, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU21W', $W . 'Longbow Female Under 21', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU21W', $W . 'Barebow Female Under 21', 1, 240);
                    ...
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU18W', $B2 . 'Recurve Female Under 18', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU18W', $B2 . 'Compound Female Under 18', $SetC, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU18W', $B2 . 'Longbow Female Under 18', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU18W', $B2 . 'Barebow Female Under 18', 1, 240);
                    ...
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU16W', $B3 . 'Recurve Female Under 16', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU16W', $B3 . 'Compound Female Under 16', $SetC, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU16W', $B3 . 'Longbow Female Under 16', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU16W', $B3 . 'Barebow Female Under 16', 1, 240);
                    ...
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU15W', $B3 . 'Recurve Female Under 15', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU15W', $B3 . 'Compound Female Under 15', $SetC, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU15W', $B3 . 'Longbow Female Under 15', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU15W', $B3 . 'Barebow Female Under 15', 1, 240);
                    ...
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU14W', $B4 . 'Recurve Female Under 14', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU14W', $B4 . 'Compound Female Under 14', $SetC, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU14W', $B4 . 'Longbow Female Under 14', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU14W', $B4 . 'Barebow Female Under 14', 1, 240);
                    ...
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU12W', $B5 . 'Recurve Female Under 12', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU12W', $B5 . 'Compound Female Under 12', $SetC, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU12W', $B5 . 'Longbow Female Under 12', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU12W', $B5 . 'Barebow Female Under 12', 1, 240);
                    ...
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'R50W', $B2 . 'Recurve Female 50+', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'C50W', $B2 . 'Compound Female 50+', $SetC, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'L50W', $B2 . 'Longbow Female 50+', 1, 240);
                    CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'B50W', $B2 . 'Barebow Female 50+', 1, 240);
                    break;
                ...
                default:
                    ...
                    switch ($subRuleName) {
                        case 'SetUKNationals':// National Championships
                            ...
                            CreateEvent($TourId, $i++, 0, 0, 16, $TargetR, 5, 3, 1, 5, 3, 1, 'RW', 'Recurve Female', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 16, $TargetC, 5, 3, 1, 5, 3, 1, 'CO', 'Compound Open', $SetC, 240);
                            CreateEvent($TourId, $i++, 0, 0, 16, $TargetC, 5, 3, 1, 5, 3, 1, 'CW', 'Compound Female', $SetC, 240);
                            CreateEvent($TourId, $i++, 0, 0, 16, $TargetR, 5, 3, 1, 5, 3, 1, 'LO', 'Longbow Open', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 16, $TargetR, 5, 3, 1, 5, 3, 1, 'LW', 'Longbow Female', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 16, $TargetR, 5, 3, 1, 5, 3, 1, 'BO', 'Barebow Open', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 16, $TargetR, 5, 3, 1, 5, 3, 1, 'BW', 'Barebow Female', 1, 240);
                            break;
                        ...
                        case 'SetUK_Metric':
                            ...
                            if ($subRuleName == 'SetUkJunNationals') {
                                ...
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RW', $appAdult . 'Recurve Female', 1, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CO', $appAdult . 'Compound Open', $SetC, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CW', $appAdult . 'Compound Female', $SetC, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LO', $appAdult . 'Longbow Open', 1, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LW', $appAdult . 'Longbow Female', 1, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BO', $appAdult . 'Barebow Open', 1, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BW', $appAdult . 'Barebow Female', 1, 240);
                            }
                            ...
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU21W', $appAdult . 'Recurve Female Under 21', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU21W', $appAdult . 'Compound Female Under 21', $SetC, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU21W', $appAdult . 'Longbow Female Under 21', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU21W', $appAdult . 'Barebow Female Under 21', 1, 240);
                            ...
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU18W', $app2 . 'Recurve Female Under 18', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU18W', $app2 . 'Compound Female Under 18', $SetC, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU18W', $app2 . 'Longbow Female Under 18', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU18W', $app2 . 'Barebow Female Under 18', 1, 240);
                            ...
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU16W', $app3 . 'Recurve Female Under 16', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU16W', $app3 . 'Compound Female Under 16', $SetC, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU16W', $app3 . 'Longbow Female Under 16', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU16W', $app3 . 'Barebow Female Under 16', 1, 240);
                            ...
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU15W', $app3 . 'Recurve Female Under 15', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU15W', $app3 . 'Compound Female Under 15', $SetC, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU15W', $app3 . 'Longbow Female Under 15', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU15W', $app3 . 'Barebow Female Under 15', 1, 240);
                            ...
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU14W', $app4 . 'Recurve Female Under 14', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU14W', $app4 . 'Compound Female Under 14', $SetC, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU14W', $app4 . 'Longbow Female Under 14', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU14W', $app4 . 'Barebow Female Under 14', 1, 240);
                            ...
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU12O', $app5 . 'Barebow Open Under 12', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'RU12W', $app5 . 'Recurve Female Under 12', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'CU12W', $app5 . 'Compound Female Under 12', $SetC, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'LU12W', $app5 . 'Longbow Female Under 12', 1, 240);
                            CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'BU12W', $app5 . 'Barebow Female Under 12', 1, 240);
                            if ($subRuleName == 'SetUkJunNationals') {
                                ...
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'R50W', $appAdult . 'Recurve Female 50+', 1, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetC, 5, 3, 1, 5, 3, 1, 'C50W', $appAdult . 'Compound Female 50+', $SetC, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'L50W', $appAdult . 'Longbow Female 50+', 1, 240);
                                CreateEvent($TourId, $i++, 0, 0, 0, $TargetR, 5, 3, 1, 5, 3, 1, 'B50W', $appAdult . 'Barebow Female 50+', 1, 240);
                            }
                            break;
...
function EventInserts($TourId){
    foreach (array('R' => 'R', 'C' => 'C', 'B' => 'B', 'L' => 'L') as $kDiv => $vDiv) {
        $clsTmpArr = array('W', 'U21W', 'U18W', 'U16W', 'U15W','U14W','U12W','50W','EF','NF');

        foreach ($clsTmpArr as $kClass => $vClass) {
            InsertClassEvent($TourId, 0, 1, $vDiv . $vClass, $kDiv, $vClass);
        }
        $clsTmpArr = array('O', 'U21O', 'U18O', 'U16O', 'U15O', 'U14O','U12O','50O','EO','NO');
        foreach ($clsTmpArr as $kClass => $vClass) {
            InsertClassEvent($TourId, 0, 1, $vDiv . $vClass, $kDiv, $vClass);
