...
switch($TourType) {
    ...
    case 12:    // WA HF 12+12
        ...
        CreateTargetFace($TourId, $i++, 'Svart påle',     'REG-^[L][MW]', '1', 6, 0, 6, 0);
        CreateTargetFace($TourId, $i++, 'Svart påle',     'REG-^[LT]U21[MW]', '1', 6, 0, 6, 0);
        ...
        CreateTargetFace($TourId, $i++, 'Svart/vit påle', 'REG-^[LT](U15|U18|50|60)[MW]', '1', 6, 0, 6, 0);
