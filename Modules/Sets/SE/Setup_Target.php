...
switch($TourType)
{
	case 1:     // WA FITA
		...
		CreateDistanceNew($TourId, $TourType, 'TU15_', array(array('20m-1',40), array('20m-2',30), array('20m-3',30), array('20m-4',20)));
		CreateDistanceNew($TourId, $TourType, 'RU15_', array(array('50m-1',50), array('40m-2',40), array('30m-3',30), array('20m-4',20)));
		CreateDistanceNew($TourId, $TourType, 'CU15_', array(array('50m-1',50), array('40m-2',40), array('30m-3',30), array('20m-4',20)));

        CreateDistanceNew($TourId, $TourType, 'BU18_', array(array('40m-1',40), array('30m-2',30), array('30m-3',30), array('20m-4',20)));
        CreateDistanceNew($TourId, $TourType, 'LU18_', array(array('40m-1',40), array('30m-2',30), array('30m-3',30), array('20m-4',20)));
        CreateDistanceNew($TourId, $TourType, 'TU18_', array(array('40m-1',40), array('30m-2',30), array('30m-3',30), array('20m-4',20)));
        CreateDistanceNew($TourId, $TourType, 'RU18_', array(array('60m-1',50), array('50m-2',40), array('40m-3',30), array('30m-4',20)));
        CreateDistanceNew($TourId, $TourType, 'CU18_', array(array('60m-1',50), array('50m-2',40), array('40m-3',30), array('30m-4',20)));
        ...
        CreateDistanceNew($TourId, $TourType, 'RU21O', array(array('50m-1',60), array('40m-2',50), array('30m-3',40), array('20m-4',30)));
		CreateDistanceNew($TourId, $TourType, 'RU21M', array(array('70m-1',70), array('60m-2',60), array('50m-3',50), array('30m-4',30)));
        CreateDistanceNew($TourId, $TourType, 'RU21W', array(array('70m-1',70), array('60m-2',60), array('50m-3',50), array('30m-4',30)));
        CreateDistanceNew($TourId, $TourType, 'CU21M', array(array('70m-1',70), array('60m-2',60), array('50m-3',50), array('30m-4',30)));
		CreateDistanceNew($TourId, $TourType, 'CU21W', array(array('70m-1',60), array('60m-2',50), array('50m-3',40), array('30m-4',30)));
		...
		CreateDistanceNew($TourId, $TourType, 'B21',  array(array('50m-1',50), array('40m-2',40), array('30m-3',30), array('20m-4',20)));
		CreateDistanceNew($TourId, $TourType, 'L21',  array(array('40m-1',40), array('30m-2',30), array('30m-3',30), array('20m-4',20)));
		CreateDistanceNew($TourId, $TourType, 'T21',  array(array('40m-1',40), array('30m-2',30), array('30m-3',30), array('20m-4',20)));
		CreateDistanceNew($TourId, $TourType, 'R21',  array(array('60m-1',60), array('50m-2',50), array('40m-3',40), array('30m-4',30)));
		CreateDistanceNew($TourId, $TourType, 'C21',  array(array('60m-1',60), array('50m-2',50), array('40m-3',40), array('30m-4',30)));
	...
	case 3:     // WA 70m Round
        ...
        CreateDistanceNew($TourId, $TourType, 'CU15_', array(array('40m-1',30), array('40m-2',30)));
        CreateDistanceNew($TourId, $TourType, 'BU15_', array(array('30m-1',30), array('30m-2',30)));
        CreateDistanceNew($TourId, $TourType, 'LU15_', array(array('20m-1',20), array('20m-2',20)));
        CreateDistanceNew($TourId, $TourType, 'TU15_', array(array('20m-1',20), array('20m-2',20)));

        CreateDistanceNew($TourId, $TourType, 'RU18_', array(array('60m-1',40), array('60m-2',40)));
        CreateDistanceNew($TourId, $TourType, 'CU18_', array(array('50m-1',30), array('50m-2',30)));
        CreateDistanceNew($TourId, $TourType, 'BU18_', array(array('40m-1',30), array('40m-2',30)));
        ...
        CreateDistanceNew($TourId, $TourType, 'RU21O', array(array('50m-1',60), array('50m-2',60)));
        CreateDistanceNew($TourId, $TourType, 'RU21M', array(array('70m-1',60), array('70m-2',60)));
        CreateDistanceNew($TourId, $TourType, 'RU21W', array(array('70m-1',60), array('70m-2',60)));
        CreateDistanceNew($TourId, $TourType, 'CU21_', array(array('50m-1',50), array('50m-2',50)));
        CreateDistanceNew($TourId, $TourType, 'BU21_', array(array('50m-1',40), array('50m-2',40)));
        CreateDistanceNew($TourId, $TourType, 'LU21_', array(array('30m-1',40), array('30m-2',40)));
        CreateDistanceNew($TourId, $TourType, 'TU21_', array(array('30m-1',40), array('30m-2',40)));
		...
		CreateDistanceNew($TourId, $TourType, 'R21',  array(array('50m-1',50), array('50m-2',50)));
		CreateDistanceNew($TourId, $TourType, 'C21',  array(array('40m-1',40), array('40m-2',40)));
		CreateDistanceNew($TourId, $TourType, 'B21',  array(array('40m-1',40), array('40m-2',40)));
		CreateDistanceNew($TourId, $TourType, 'L21',  array(array('30m-1',30), array('30m-2',30)));
		CreateDistanceNew($TourId, $TourType, 'T21',  array(array('30m-1',30), array('30m-2',30)));
	...
	case 37:  // Double 70m/50m round
		...
		CreateDistanceNew($TourId, $TourType, 'RU15_', array(array('40m-1',40), array('40m-2',40), array('40m-3',40), array('40m-4',40)));
		CreateDistanceNew($TourId, $TourType, 'CU15_', array(array('40m-1',30), array('40m-2',30), array('40m-3',30), array('40m-4',30)));
		CreateDistanceNew($TourId, $TourType, 'BU15_', array(array('30m-1',30), array('30m-2',30), array('30m-3',30), array('30m-4',30)));
		CreateDistanceNew($TourId, $TourType, 'LU15_', array(array('20m-1',20), array('20m-2',20), array('20m-3',20), array('20m-4',20)));
		CreateDistanceNew($TourId, $TourType, 'TU15_', array(array('20m-1',20), array('20m-2',20), array('20m-3',20), array('20m-4',20)));

        CreateDistanceNew($TourId, $TourType, 'RU18_', array(array('60m-1',40), array('60m-2',40), array('60m-3',40), array('60m-4',40)));
        CreateDistanceNew($TourId, $TourType, 'CU18_', array(array('50m-1',30), array('50m-2',30), array('50m-3',30), array('50m-4',30)));
        CreateDistanceNew($TourId, $TourType, 'BU18_', array(array('40m-1',30), array('40m-2',30), array('40m-3',30), array('40m-4',30)));
        CreateDistanceNew($TourId, $TourType, 'LU18_', array(array('30m-1',30), array('30m-2',30), array('30m-3',30), array('30m-4',30)));
        CreateDistanceNew($TourId, $TourType, 'TU18_', array(array('30m-1',30), array('30m-2',30), array('30m-3',30), array('30m-4',30)));

        CreateDistanceNew($TourId, $TourType, 'RU21O', array(array('50m-1',60), array('50m-2',60), array('50m-3',60), array('50m-4',60)));
		CreateDistanceNew($TourId, $TourType, 'RU21M', array(array('70m-1',60), array('70m-2',60), array('70m-3',60), array('70m-4',60)));
        CreateDistanceNew($TourId, $TourType, 'RU21W', array(array('70m-1',60), array('70m-2',60), array('70m-3',60), array('70m-4',60)));
		CreateDistanceNew($TourId, $TourType, 'CU21_', array(array('50m-1',50), array('50m-2',50), array('50m-3',50), array('50m-4',50)));
		CreateDistanceNew($TourId, $TourType, 'BU21_', array(array('50m-1',40), array('50m-2',40), array('50m-3',40), array('50m-4',40)));
		CreateDistanceNew($TourId, $TourType, 'LU21_', array(array('30m-1',40), array('30m-2',40), array('30m-3',40), array('30m-4',40)));
		CreateDistanceNew($TourId, $TourType, 'TU21_', array(array('30m-1',40), array('30m-2',40), array('30m-3',40), array('30m-4',40)));
		...
		CreateDistanceNew($TourId, $TourType, 'R21',  array(array('50m-1',50), array('50m-2',50), array('50m-3',50), array('50m-4',50)));
		CreateDistanceNew($TourId, $TourType, 'C21',  array(array('40m-1',40), array('40m-2',40), array('40m-3',40), array('40m-4',40)));
		CreateDistanceNew($TourId, $TourType, 'B21',  array(array('40m-1',40), array('40m-2',40), array('40m-3',40), array('40m-4',40)));
		CreateDistanceNew($TourId, $TourType, 'L21',  array(array('30m-1',30), array('30m-2',30), array('30m-3',30), array('30m-4',30)));
		CreateDistanceNew($TourId, $TourType, 'T21',  array(array('30m-1',30), array('30m-2',30), array('30m-3',30), array('30m-4',30)));
	...
	case 5:     // WA 900 Round
        ...
        CreateDistanceNew($TourId, $TourType, 'RU15_', array(array('40m-1',40), array('30m-2',30), array('20m-3',20)));
        CreateDistanceNew($TourId, $TourType, 'CU15_', array(array('40m-1',40), array('30m-2',30), array('20m-3',20)));
		CreateDistanceNew($TourId, $TourType, 'BU15_', array(array('40m-1',40), array('30m-2',30), array('20m-3',20)));
        CreateDistanceNew($TourId, $TourType, 'LU15_', array(array('20m-1',40), array('20m-2',30), array('20m-3',20)));
        ...
        CreateDistanceNew($TourId, $TourType, 'RU21O', array(array('40m-1',40), array('30m-2',30), array('20m-3',20)));
        CreateDistanceNew($TourId, $TourType, 'RU21M', array(array('60m-1',60), array('50m-2',50), array('40m-3',40)));
        ...
        CreateDistanceNew($TourId, $TourType, 'L21',  array(array('40m-1',40), array('30m-2',30), array('20m-3',20)));
		...
		CreateDistanceNew($TourId, $TourType, 'T21',  array(array('40m-1',40), array('30m-2',30), array('20m-3',20)));
		...
		CreateDistanceNew($TourId, $TourType, 'R21',  array(array('60m-1',60), array('50m-2',50), array('40m-3',40)));
		CreateDistanceNew($TourId, $TourType, 'C21',  array(array('60m-1',60), array('50m-2',50), array('40m-3',40)));
		CreateDistanceNew($TourId, $TourType, 'B21',  array(array('40m-1',40), array('30m-2',30), array('20m-3',20)));
	...
	case 22:    // WA Indoor 18, 1 distance
		...
		CreateDistanceNew($TourId, $TourType, '_U15_', array(array('12m-1',12), array('12m-2',12)));
		...
		CreateDistanceNew($TourId, $TourType, '_21',   array(array('18m-1',18), array('18m-2',18)));
	...
	case 7:     // WA Indoor 25
		CreateDistanceNew($TourId, $TourType, '_U13_', array(array('12m-1',12), array('12m-2',12)));
		CreateDistanceNew($TourId, $TourType, '_U15_', array(array('12m-1',12), array('12m-2',12)));
        CreateDistanceNew($TourId, $TourType, '_U18_', array(array('25m-1',25), array('25m-2',25)));
		CreateDistanceNew($TourId, $TourType, '_U21_', array(array('25m-1',25), array('25m-2',25)));
		CreateDistanceNew($TourId, $TourType, '_21',  array(array('25m-1',25), array('25m-2',25)));
	...
	case 39:    // 36Arr70mRound
        ...
        CreateDistanceNew($TourId, $TourType, 'C50_',  array(array('50m',50)));
        CreateDistanceNew($TourId, $TourType, 'CU18_', array(array('40m',40)));
		CreateDistanceNew($TourId, $TourType, 'C21',   array(array('40m',40)));
		...
		CreateDistanceNew($TourId, $TourType, 'CU15_', array(array('30m',30)));
        CreateDistanceNew($TourId, $TourType, 'B_',    array(array('30m',30)));
		CreateDistanceNew($TourId, $TourType, 'RU15_', array(array('20m',20)));
        CreateDistanceNew($TourId, $TourType, 'RU21O', array(array('20m',20)));
		CreateDistanceNew($TourId, $TourType, 'BU15_', array(array('20m',20)));
        CreateDistanceNew($TourId, $TourType, 'BU18_', array(array('20m',20)));
		CreateDistanceNew($TourId, $TourType, 'BU21_', array(array('20m',20)));
		CreateDistanceNew($TourId, $TourType, 'B21',   array(array('20m',20)));
		...
		CreateDistanceNew($TourId, $TourType, 'LU15_', array(array('20m',20)));
        CreateDistanceNew($TourId, $TourType, 'LU18_', array(array('20m',20)));
		CreateDistanceNew($TourId, $TourType, 'LU21_', array(array('20m',20)));
		CreateDistanceNew($TourId, $TourType, 'L21',   array(array('20m',20)));
        ...
        CreateDistanceNew($TourId, $TourType, 'TU15_', array(array('20m',20)));
        CreateDistanceNew($TourId, $TourType, 'TU18_', array(array('20m',20)));
        CreateDistanceNew($TourId, $TourType, 'TU21_', array(array('20m',20)));
        CreateDistanceNew($TourId, $TourType, 'T21',   array(array('20m',20)));
...
switch($TourType)
{
	case 1:  // Full FITA
        ...
        CreateTargetFace($TourId, $i++, '10 ring 122/80cm', 'RU21O', '1',  5, 122, 5, 122, 5, 80, 5, 80);
		CreateTargetFace($TourId, $i++, '10 ring 122/80cm', 'REG-^[C](U15|U18|U21|21|50|60)?[MW]', '1', 5, 122, 5, 122, 9, 80, 9, 80);
        CreateTargetFace($TourId, $i++, '10 ring 122/80cm', 'REG-^[C]21', '1', 5, 122, 5, 122, 9, 80, 9, 80);
		break;

	case 3:  // 70m/50m round
		CreateTargetFace($TourId, $i++, '10 ring 122cm', '_U13_', '1', 5, 122, 5, 122);
		CreateTargetFace($TourId, $i++, '10 ring 122cm', 'REG-^[RBLT](U15|U18|U21|21|50|60)?[MW]', '1', 5, 122, 5, 122);
        CreateTargetFace($TourId, $i++, '10 ring 122cm', 'REG-^[RBLT]21', '1', 5, 122, 5, 122);
        CreateTargetFace($TourId, $i++, '10 ring 122cm', 'RU21O', '1', 5, 122, 5, 122);
		CreateTargetFace($TourId, $i++, '6 ring 80cm',   'REG-^[C](U15|U18|U21|21|50|60)?[MW]', '1', 9, 80, 9, 80);
        CreateTargetFace($TourId, $i++, '6 ring 80cm',   'REG-^[C]21', '1', 9, 80, 9, 80);
		break;

    case 37: // Double 70m/50m round
        CreateTargetFace($TourId, $i++, '10 ring 122cm', '_U13_', '1', 5, 122, 5, 122, 5, 122, 5, 122);
        CreateTargetFace($TourId, $i++, '10 ring 122cm', 'REG-^[RBLT](U15|U18|U21|21|50|60)?[MW]', '1', 5, 122, 5, 122, 5, 122, 5, 122);
        CreateTargetFace($TourId, $i++, '10 ring 122cm', 'REG-^[RBLT]21', '1', 5, 122, 5, 122, 5, 122, 5, 122);
        CreateTargetFace($TourId, $i++, '10 ring 122cm', 'RU21O', '1', 5, 122, 5, 122, 5, 122, 5, 122);
        CreateTargetFace($TourId, $i++, '6 ring 80cm',   'REG-^[C](U15|U18|U21|21|50|60)?[MW]', '1', 9, 80, 9, 80, 9, 80, 9, 80);
        CreateTargetFace($TourId, $i++, '6 ring 80cm',   'REG-^[C]21', '1', 9, 80, 9, 80, 9, 80, 9, 80);
        break;
	...
	case 6:  // Indoor 18m, 2 Dist - 60 arrows
		...
		CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[R](U15|U18|U21|50|60)?[MW]', '1', 2, 40, 2, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[R](U15|U18|U21|50|60)?[MW]', '0', 1, 40, 1, 40);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[R]21', '1', 2, 40, 2, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[R]21', '0', 1, 40, 1, 40);
		CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[C](U15|U18|U21|50|60)?[MW]', '1', 4, 40, 4, 40);
		CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[C]21', '1', 4, 40, 4, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[C](U15|U18|U21|50|60)?[MW]', '0', 3, 40, 3, 40);
		CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[B](U15|U18|U21|50|60)?[MW]', '1', 1, 40, 1, 40);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[B](U15|U18|U21|21|50|60)?[MW]', '0', 2, 40, 2, 40);
		CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[B]21', '1', 1, 40, 1, 40);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[B]21', '0', 2, 40, 2, 40);
		CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[LT](U15|U18|U21|50|60)?[MW]', '1', 1, 60, 1, 60);
		CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[LT]21', '1', 1, 60, 1, 60);
		break;

	case 7:  // Indoor 25m, 2 Dist - 60 arrows
        CreateTargetFace($TourId, $i++, '10 ring 60cm', '_U13_', '1', 1, 60, 1, 60);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[RB](U15)[MW]', '1', 1, 40, 1, 40);
        CreateTargetFace($TourId, $i++, '3 spot 40cm', 'REG-^[RB](U15)[MW]', '0', 2, 40, 2, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[C](U15)[MW]', '1', 3, 40, 3, 40);
        CreateTargetFace($TourId, $i++, '3 spot 40cm', 'REG-^[C](U15)[MW]', '0', 4, 40, 4, 40);
        CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[LT](U15)[MW]', '1', 1, 60, 1, 60);
        CreateTargetFace($TourId, $i++, '3 spot 60cm', 'REG-^[R](U18|U21|50|60)?[MW]', '1', 2, 60, 2, 60);
        CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[R](U18|U21|50|60)?[MW]', '0', 1, 60, 1, 60);
        CreateTargetFace($TourId, $i++, '3 spot 60cm', 'REG-^[R]21', '1', 2, 60, 2, 60);
        CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[R]21', '0', 1, 60, 1, 60);
        CreateTargetFace($TourId, $i++, '3 spot 60cm', 'REG-^[C](U18|U21|50|60)?[MW]', '1', 4, 60, 4, 60);
        CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[C](U18|U21|50|60)[MW]', '0', 3, 60, 3, 60);
        CreateTargetFace($TourId, $i++, '3 spot 60cm', 'REG-^[C]21', '1', 4, 60, 4, 60);
        CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[C]21', '0', 3, 60, 3, 60);
		CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[BLT](U18|U21|50|60)?[MW]', '1', 1, 60, 1, 60);
		CreateTargetFace($TourId, $i++, '3 spot 60cm', 'REG-^[BLT](U18|U21|50|60)?[MW]', '0', 2, 60, 2, 60);
		CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[BLT]21', '1', 1, 60, 1, 60);
		CreateTargetFace($TourId, $i++, '3 spot 60cm', 'REG-^[BLT]21', '0', 2, 60, 2, 60);
		break;

	case 22:  // Indoor 18m, 1 Dist - 30 arrows
        CreateTargetFace($TourId, $i++, '10 ring 60cm', '_U13_', '1', 1, 60);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[R](U15|U18|U21|50|60)?[MW]', '1', 2, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[R](U15|U18|U21|50|60)?[MW]', '0', 1, 40);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[R]21', '1', 2, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[R]21', '0', 1, 40);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[C](U15|U18|U21|50|60)?[MW]', '1', 4, 40);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[C]21', '1', 4, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[C](U15|U18|U21|50|60)?[MW]', '0', 3, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[B](U15|U18|U21|50|60)?[MW]', '1', 1, 40);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[B](U15|U18|U21|21|50|60)?[MW]', '0', 2, 40);
        CreateTargetFace($TourId, $i++, '10 ring 40cm', 'REG-^[B]21', '1', 1, 40);
        CreateTargetFace($TourId, $i++, '3 spot', 'REG-^[B]21', '0', 2, 40);
        CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[LT](U15|U18|U21|50|60)?[MW]', '1', 1, 60);
        CreateTargetFace($TourId, $i++, '10 ring 60cm', 'REG-^[LT]21', '1', 1, 60);
		break;
