...
if($on and $_SESSION["TourLocRule"]=='CH'){
  $ret['SAA'][] = 'SwissArchery';
//  $ret['SAA'][] = get_text('SetCHRecords','Install') . '|' . $CFG->ROOT_DIR . 'Modules/Sets/CH/' . 'SAARecords/SAARecords.php';
  $ret['SAA'][] = get_text('SetCHExport','Install') . '|' . $CFG->ROOT_DIR . 'Tournament/ExportASC.php';
  $ret['SAA'][] = get_text('SetCHResults','Install') . '|' . $CFG->ROOT_DIR . 'Qualification/PrintOut.php';
}
/*
