...
modalità:
Picchetto Giallo: Giovanissimi (Arco Ricurvo e Arco Nudo), Ragazzi Arco Nudo e Longbow (classe unica maschile e classe unica femminile)
Picchetto Blu: Ragazzi Arco Ricurvo e Arco Compound.
...
switch($TourType) {
	...
	case 10:
	case 12:
		CreateTargetFace($TourId, 1, 'Picch. Giallo', 'REG-^(OLG|COG|AN[AGR]|LB|AI[MF])', '1', 6, 0, 6, 0);
		CreateTargetFace($TourId, 2, 'Picch. Blu', 'REG-^(AN[^AGR]|OL[AR]|CO[AR])', '1', 6, 0, 6, 0);
