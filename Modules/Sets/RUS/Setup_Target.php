...
switch($TourType) {
	...
	case 5:
		...
		break;
	case 6:
        CreateDistanceNew($TourId, $TourType, '_U14_', array(array('12m-1',12), array('12m-2',12)));
    ...
    case 37:
		switch($SubRule) {
			case '1':
				...
				CreateDistanceNew($TourId, $TourType, 'RU14_', array(array('40m-1',40), array('40m-2',40), array('40m-1',40), array('40m-2',40)));
				...
				CreateDistanceNew($TourId, $TourType, 'CU14_', array(array('40m-1',40), array('40m-2',40), array('40m-1',40), array('40m-2',40)));
				...
				CreateDistanceNew($TourId, $TourType, 'BU14_', array(array('30m-1',30), array('30m-2',30), array('30m-1',30), array('30m-2',30)));
		...
		break;
    case 1001:
        CreateDistanceNew($TourId, $TourType, '%', array(array('50m',50), array('30m',30)));
        break;
    case 1002:
        CreateDistanceNew($TourId, $TourType, '%', array(array('12m-1',12), array('12m-2',12)));
        break;
}

if($TourType<5 or in_array($TourType, [6, 18, 37, 1001, 1002])) {
	// default Events
...
switch($TourType) {
	...
	case 8:
		...
		break;
    case 1001:
        CreateTargetFace($TourId, 2, '~Default', '%', '1',  9, 80, 10, 80);
        break;
    case 1002:
        CreateTargetFace($TourId, 3, '~Default', '%', '1',  1, 40, 1, 40);
        break;
}
