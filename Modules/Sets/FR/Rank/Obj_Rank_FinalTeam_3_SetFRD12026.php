 ...
 * )
 */
	class Obj_Rank_FinalTeam_3_SetFRD12026 extends Obj_Rank
	{
	/**
	 * safeFilterR()
				...
				(
					...
					FROM
                        ...
                        left join (
                            ...
                            group by TqdCoId, TqdSubTeam, TqdEvent) tqd on TqdCoId=TeCoId and TqdSubTeam=TeSubTeam and TqdEvent=TeEvent
					WHERE
