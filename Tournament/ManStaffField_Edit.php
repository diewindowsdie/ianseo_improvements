	...
	switch($_REQUEST['act']) {
		...
		case 'edit':
			...
			$SQL=array(
				...
				"TiName=".StrSafe_DB(trim($_REQUEST['FamilyName'])),
				"TiGivenName=".StrSafe_DB(trim($_REQUEST['GivenName'])),
                "TiLastName=".($_REQUEST['LastName'] ? trim(StrSafe_DB($_REQUEST['LastName'])) : 'null'),
